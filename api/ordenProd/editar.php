...
if(
    ...
    if($obj_ordenProd->editar()){
        // asignar codigo de respuesta - 201 creado
        http_response_code(201);
        // informar al usuario
        echo json_encode(array("message" => "La orden ha sido modificada."));
    }
    // si no puede crear la actividad, informar al usuario
        ...
        // informar al usuario
        echo json_encode(array("message" => "No se puede editar la orden."));
    }
}
// informar al usuario que los datos estan incompletos
    ...
    // informar al usuario
    echo json_encode(array("message" => "No se puede editar la orden. Los datos estan incompletos."));
}
